...
cd /home/roboshop && rm -rf catalogue &>>${LOG_FILE} && unzip /tmp/catalogue.zip && mv catalogue-main catalogue &>>${LOG_FILE}
statusCheck $?
...
mv mv /home/roboshop/catalogue/systemd.service /etc/systemd/system/catalogue.service
